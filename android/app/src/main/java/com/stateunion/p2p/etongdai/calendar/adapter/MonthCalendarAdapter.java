package com.stateunion.p2p.etongdai.calendar.adapter;
...
import com.stateunion.p2p.etongdai.calendar.utils.CalendarUtil;
...
public class MonthCalendarAdapter extends CalendarAdapter {
    ...
    public MonthCalendarAdapter(List<View> views, Context context, ArrayList<String> list) {
        ...
        mGrayColor = context.getResources().getColor(R.color.font_gray);
